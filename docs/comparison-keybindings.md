...
- **Drift**: Arrow keys for the two directional actions it has (`cycleAlign`, `shiftViewport`); `Tab` for column focus; `Page_Up`/`Page_Down` for strip paging.
