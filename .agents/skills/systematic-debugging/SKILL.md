...
4. **Gather Evidence in Multi-Component Systems**
   ...
   **Example (addon package and optional Python tooling):**
   ```bash
   # Layer 1: Are the addon dependencies available?
   npm install
   ...
   **This reveals:** Which dependency, build, test, or focused Python test layer fails.

5. **Trace Data Flow**

   **WHEN error is deep in call stack:**

   See `defense-in-depth.md` in this directory for layered investigation techniques.
...
1. **Create Failing Test Case**
   ...
   - Use the `skills:test-driven-development` skill for writing proper failing tests
